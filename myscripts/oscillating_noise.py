...
class MyEulerDiscreteScheduler(EulerDiscreteScheduler):
    def step(
        ...
        if dt < 0:
            ...
            # add noise if noise schedule goes up
            prev_sample = sample + noise * dt
...
sigmas = [14.6146, 10.7469,  8.0815,  6.2050,  4.8557,  3.8654,  3.1238,  2.5572,
         2.1157,  1.7648,  1.4806,  1.2458,  1.0481,  0.8784,  0.7297,  0.5964,
         0.4736,  0.3555,  0.2322,  0.0292, 0.015, 0.0292, 0.015, 0.0292, 0.0000]
...
for i, im in enumerate(images):
    im.save(f"myscripts/testc{i}.png","PNG")